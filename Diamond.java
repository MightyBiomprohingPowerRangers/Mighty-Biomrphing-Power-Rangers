...
public class Diamond extends Cluster 
{
	public Diamond()
	{
		for (int xcoord = -5; xcoord < 6; xcoord++ )
		{
			...
			{
				points.add(new ClusterPoint(xcoord, 0));
			}
			...
			else if (xcoord == -3 || xcoord == 3)
			{
				for (int ycoord = -2 ; ycoord < 3; ycoord++ )
				points.add(new ClusterPoint(xcoord, ycoord));
			}
			else if (xcoord == -2 || xcoord == 2)
			{
